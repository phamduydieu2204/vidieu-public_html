...
(function($) {
    ...
    function translateProductTexts() {
        ...
        $('.product-visitors').each(function() {
            var html = $(this).html();
            if (html && html.indexOf('people are viewing this right now') > -1) {
                $(this).html(html.replace('people are viewing this right now', 'người đang xem sản phẩm này ngay bây giờ'));
            }
        });
