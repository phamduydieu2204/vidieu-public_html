...
if (!function_exists('elessi_back_history')) :
    function elessi_back_history() {
        ...
        $url = apply_filters('nasa_back_history', $back_url);
        
        // return '<a class="ns-back-history margin-right-10 rtl-margin-right-0 rtl-margin-left-10" href="' . $url . '" title="' . esc_attr__('Back', 'elessi-theme') . '" rel="nofollow"><svg xmlns="http://www.w3.org/2000/svg" fill="none" stroke-width="1" viewBox="0 0 24 24" width="28" height="28"><path d="M18.5 12H6M6 12L12 6M6 12L12 18" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"/></svg></a>';
        
        return '<a class="ns-back-history margin-right-10 rtl-margin-right-0 rtl-margin-left-10 nasa-flex" href="' . $url . '" title="' . esc_attr__('Back', 'elessi-theme') . '" rel="nofollow"><svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 256 256" height="20" width="20"><path d="M91.474,33.861l-89.6,89.6c-2.5,2.5-2.5,6.551,0,9.051l89.6,89.6c2.5,2.5,6.551,2.5,9.051,0s2.5-6.742,0-9.242L21.849,134  H249.6c3.535,0,6.4-2.466,6.4-6s-2.865-6-6.4-6H21.849l78.676-78.881c1.25-1.25,1.875-2.993,1.875-4.629s-0.625-3.326-1.875-4.576  C98.024,31.413,93.974,31.361,91.474,33.861z"/></svg></a>';
    }
endif;
