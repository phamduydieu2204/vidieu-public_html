...
if (!function_exists('elessi_static_compare_sidebar')) :
    function elessi_static_compare_sidebar() {
        ...
        <div class="nasa-compare-list-bottom">
            ...
            <?php /* p class="nasa-compare-mess nasa-compare-success hidden-tag"></p>
        ...
        <script type="text/template" id="ns-sale-notification-tml">
            <div class="wrapper-noti">
                ...
                <div class="wrapper-theme">
                    ...
                    <div class="noti-title nasa-bold">
                        {{customer}}
                    </div>

                    <a class="noti-body" href="{{p_url}}" title="{{p_name}}" target="_blank">{{p_name}}</a>
