    ...
    <div class="row">
        <div class="large-12 columns">
            <table>
                <tr>
                    <td class="nasa-td-30">
                        <h5 class="clearfix text-center mobile-text-left rtl-mobile-text-right nasa-compare-label"><span class="nasa-block mobile-text-center mobile-margin-top-15 mobile-margin-bottom-5 mobile-fs-23"><?php esc_html_e('Compare Products', 'elessi-theme'); ?></span><span class="color-gray hide-for-mobile"> (<?php echo ($count_compare); ?> <?php esc_html_e('Products', 'elessi-theme'); ?>)</span></h5>
                    </td>
