                        ...
                        $output .= '
                            <div class="fake_purchases_demo hidden-tag">
                                ...
                                <div class="wrapper-theme">
                                    ...
                                    <div class="noti-time">
                                        <span class="time_purchased">' . esc_html__('Time ago', 'elessi-theme') . '</span><span class="verify"><i class="pe-icon pe-7s-check"></i>' . esc_html__('Verified', 'elessi-theme') . '</span>
                                    </div>
                            ...
                            <template class="product-item-tmpl hidden-tag">
                                <div class="product_list_item">
                                    ...
                                    <div class="wrapper-theme">
                                        ...
                                        <div class="noti-body">
                                            <a class="nameproduct" href="{{p_url}}">{{p_name}}</a>
                                        </div>
                                        
                                        <div class="noti-time">
                                            <span class="time_purchased">{{time_purchase}}</span>
                                            <span class="verify"><i class="pe-icon pe-7s-check"></i>Verified</span>
                                        </div>
                                    ...
                                    <a href="javascript:void(0);" class="delete_btn"><i class="pe-7s-trash"></i></a>
                                    <a href="javascript:void(0);" class="change_btn"><i class="pe-7s-pen"></i></a>
                                </div>
                            </template>';
