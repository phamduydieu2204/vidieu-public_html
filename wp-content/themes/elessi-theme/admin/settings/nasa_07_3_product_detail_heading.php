...
if (!function_exists('elessi_product_detail_heading')) {
    function elessi_product_detail_heading() {
        ...
        $of_options[] = array(
            "name" => esc_html__('WooCommerce Tabs Off - Canvas in Mobile (Not use Mobile App - Simulator)', 'elessi-theme'),
        ...
        $of_options[] = array(
            "name" => esc_html__("Columns Relate | You may also like&hellip;", 'elessi-theme'),
        ...
        $of_options[] = array(
            "name" => esc_html__("Columns Relate | You may also like&hellip; for Tablet", 'elessi-theme'),
        ...
        $of_options[] = array(
            "name" => esc_html__("Columns Relate | You may also like&hellip; for Mobile", 'elessi-theme'),
        ...
        $of_options[] = array(
            "name" => esc_html__("Auto Slide - Relate | You may also like&hellip;", 'elessi-theme'),
        ...
        $of_options[] = array(
            "name" => esc_html__('Turn Off Sidebar on Mobile Device', 'elessi-theme'),
            "desc" => esc_html__("Yes, Please!", 'elessi-theme'),
