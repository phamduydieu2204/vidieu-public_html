/**
 * Contact form JavaScript - Scoped to contact page only
 */
(function($) {
    'use strict';
    
    $(document).ready(function() {
        // Only run on pages with contact form
        var $contactForm = $('#vd-contact-form');
        ...
        $contactForm.on('submit', function(e) {
            ...
            .fail(function() {
                $message.addClass('error').html(vd_ajax_object.error_message || 'Đã có lỗi xảy ra. Vui lòng thử lại.').show();
            })
            .always(function() {
        ...
        // Optional: Add form validation - only for contact form fields
        ...
        // Clear error state on focus - only for contact form
        $contactForm.find('input, textarea').on('focus', function() {
            $(this).removeClass('error');
        });
        
        // Optional: Phone number formatting - only for contact phone field
