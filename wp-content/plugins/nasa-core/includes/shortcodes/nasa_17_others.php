...
function nasa_register_others(){
    ...
    // **********************************************************************//
    $params = array(
        "name" => esc_html__("Icon Box", 'nasa-core'),
        "base" => "nasa_icon_box",
        'icon' => 'icon-wpb-nasatheme',
        'description' => esc_html__("Create icon box.", 'nasa-core'),
        "content_element" => true,
        "category" => 'Nasa Core',
        "params" => array(
            array(
                'type' => 'attach_image',
                'heading' => esc_html__('Box Image', 'nasa-core'),
                'param_name' => 'box_img',
                'value' => '',
                'admin_label' => true,
            ...
            array(
                "type" => "textfield",
                "heading" => esc_html__("Box Title", 'nasa-core'),
            ...
            array(
                "type" => "textfield",
                "heading" => esc_html__("Box Description", 'nasa-core'),
                "param_name" => "box_desc",
                "admin_label" => true,
            ),
            ...
            array(
                "type" => "textfield",
                "heading" => esc_html__("Box link", 'nasa-core'),
                "param_name" => "box_link",
                "admin_label" => true,
            ),
            ...
            array(
                "type" => "dropdown",
                "heading" => esc_html__("Box Style", 'nasa-core'),
