...
function nasa_register_product(){
    ...
    $maps = array(
        ...
        "params" => array(
            ...
            array(
                ...
                "description" => esc_html__("Only using for Style is Slider.", 'nasa-core')
            ),
            ...
            array(
                ...
                "std" => 'top',
                "description" => esc_html__("Only using for Style is Slider 1 row.", 'nasa-core')
            ),

            array(
                "type" => "dropdown",
                "heading" => esc_html__("Title align (Only use for Style is Slider)", 'nasa-core'),
            ...
            array(
                ...
                "description" => esc_html__("Only using for Style is Slider or Simple Slide.", 'nasa-core')
            ),
            ...
            array(
                ...
                "description" => esc_html__("Only using for Slide.", 'nasa-core')
            ),
    ...
    if (isset($nasa_opt['enable_nasa_brands']) && $nasa_opt['enable_nasa_brands']) {
        $maps['params'][] = array(
            "type" => "dropdown",
            "heading" => esc_html__("Product Brand - Nasa", 'nasa-core'),
            "param_name" => "ns_brand",
            "admin_label" => true,
    ...
    if (defined('PWB_PLUGIN_NAME')) {
        $maps['params'][] = array(
            "type" => "dropdown",
            "heading" => esc_html__("Product Brand (PWB)", 'nasa-core'),
