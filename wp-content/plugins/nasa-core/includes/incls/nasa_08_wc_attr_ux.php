                    ...
                    if (in_array($term->slug, $array_keys)) {
                        ...
                        if ($this->_max_show) {
                            if ($k == $this->_max_show + 1) {
                                $this->_content .= '<a href="javascript:void(0);" class="nasa-attr-ux-more nasa-attr-ux-' . self::_NASA_LABEL . '" rel="nofollow">+' . (count($terms) - $this->_max_show) . '</a>';
                            }
                        ...
                        $this->_content .= sprintf(
                            '<a href="javascript:void(0);" class="' . $class . ' nasa-attr-ux-' . self::_NASA_LABEL . ' nasa-attr-ux-%s %s" data-value="%s" data-pa="%s" data-act="%s" rel="nofollow">%s</a>',
                            esc_attr($term->slug),
            ...
            foreach ($this->_outputs[self::_NASA_COLOR] as $attr_name => $objs) {
                ...
                foreach ($terms as $term) {
                    if (in_array($term->slug, $array_keys)) {
                        ...
                        if ($this->_max_show) {
                            if ($k == $this->_max_show + 1) {
                                $this->_content .= '<a href="javascript:void(0);" class="nasa-attr-ux-more nasa-attr-ux-' . self::_NASA_COLOR . '" rel="nofollow">+' . (count($terms) - $this->_max_show) . '</a>';
                            }
                        ...
                        $this->_content .= sprintf(
                            '<a href="javascript:void(0);" class="' . $class . ' nasa-attr-ux-' . self::_NASA_COLOR . ' nasa-attr-ux-%s %s" data-value="%s" data-pa="%s" data-act="%s" rel="nofollow"><span style="background-color:%s;">%s</span></a>',
                            esc_attr($term->slug),
                            $active_curr ? 'nasa-active' : '',
                            esc_attr($term->slug),
                            sanitize_title($attr_name),
            ...
            foreach ($this->_outputs[self::_NASA_IMAGE] as $attr_name => $objs) {
                ...
                foreach ($terms as $term) {
                    if (in_array($term->slug, $array_keys)) {
                        ...
                        if ($this->_max_show) {
                            if ($k == $this->_max_show + 1) {
                                $this->_content .= '<a href="javascript:void(0);" class="nasa-attr-ux-more nasa-attr-ux-' . self::_NASA_IMAGE . '" rel="nofollow">+' . (count($terms) - $this->_max_show) . '</a>';
                            }
                        ...
                        $this->_content .= sprintf(
                            '<a href="javascript:void(0);" class="' . $class . ' nasa-attr-ux-' . self::_NASA_IMAGE . ' nasa-attr-ux-%s %s" data-value="%s" data-pa="%s" data-act="%s" rel="nofollow">%s</a>',
                            esc_attr($term->slug),
                            $active_curr ? 'nasa-active' : '',
                            esc_attr($term->slug),
                            sanitize_title($attr_name),
