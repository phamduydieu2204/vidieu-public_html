...
function nasa_get_menu_options($key_first = false) {
    ...
    if (!isset($nasa_menu_options[$key])) {
        $nasa_menu_options[$key] = !$key_first ? array(esc_html__("Select menu", 'nasa-core') => '') : array('' => esc_html__("Select menu", 'nasa-core'));
...
function nasa_get_pin_arrays($type = 'nasa_pin_pb', $key_first = false) {
    ...
    if (!isset($nasa_pins[$key])) {
        $nasa_pins[$key] = !$key_first ? array(esc_html__('Select Item', 'nasa-core') => '') : array('' => esc_html__('Select Item', 'nasa-core'));
...
function nasa_get_revsliders_arrays($key_first = false) {
    ...
    if (!isset($nasa_revsliders[$key])) {
        $nasa_revsliders[$key] = !$key_first ? array(esc_html__('Select Rev Slider Item', 'nasa-core') => '') : array('' => esc_html__('Select Rev Slider Item', 'nasa-core'));
