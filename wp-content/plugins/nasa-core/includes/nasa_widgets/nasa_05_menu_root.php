...
class Nasa_Menu_Root_Elm extends Nasa_ELM_Widgets_Abs {
    ...
    public function get_title() {
        return __('Nasa Menu Root', 'nasa-core');
    }
...
// Register Widgets.
Plugin::instance()->widgets_manager->register(new Nasa_Menu_Root_Elm());
