 ...
 */
class Nasa_Banner_2_Elm extends Nasa_ELM_Widgets_Abs {

    /**
     * @return string Shortcode name.
     */
    protected function _shortcode() {
        return 'nasa_banner_2';
    }
    ...
    public function get_title() {
        return __('Nasa Banner v2', 'nasa-core');
    }
    ...
    protected function register_controls() {
        ...
        $this->add_control(
            'img_src',
            [
                'label' => __('Choose Image', 'nasa-core'),
    ...
    protected function render() {
        ...
        $atts = [
            ...
            'content_width'     => isset($settings['content_width']) ? $settings['content_width'] : '',
            ...
            'text_align'        => isset($settings['text_align']) ? $settings['text_align'] : 'text-left',
...
// Register Widgets.
Plugin::instance()->widgets_manager->register(new Nasa_Banner_2_Elm());
