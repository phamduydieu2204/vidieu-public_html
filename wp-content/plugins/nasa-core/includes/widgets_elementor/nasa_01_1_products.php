...
class Nasa_Products_WGSC extends Nasa_Elementor_Widget {
    ...
    function __construct() {
        ...
        $this->widget_description = esc_html__('Display Products', 'nasa-core');
        ...
        $this->settings = array(
            ...
            'pos_nav' => array(
                'type' => 'select',
                'std' => 'both',
                'label' => esc_html__('Position Title | Navigation (The Top Only use for Style is Slider)', 'nasa-core'),
                'options' => array(
            ...
            'title_align' => array(
                'type' => 'select',
                'std' => 'left',
                'label' => esc_html__('Title align (Only use for Style is Slider)', 'nasa-core'),
                'options' => array(
            ...
            /* 'shop_url' => array(
                'type' => 'select',
                'std' => '0',
                'label' => esc_html__('Shop URL (Only use for Style is Slider)', 'nasa-core'),
            ...
            'arrows' => array(
                'type' => 'select',
                'std' => '1',
                'label' => esc_html__('Arrows (Only use for Style is Slider or Simple Slide)', 'nasa-core'),
                'options' => $this->array_bool_number()
            ),
            ...
            'dots' => array(
                'type' => 'select',
                'std' => 'false',
                'label' => esc_html__('Dots (Only use for Style is Slider or Simple Slide 2)', 'nasa-core'),
            ...
            'columns_number_small_slider' => array(
                'type' => 'select',
                'std' => 2,
                'label' => esc_html__('Columns Number Small for Carousel', 'nasa-core'),
        ...
        $this->settings['ns_brand'] = array(
            'type' => 'product_brands',
            'std' => '',
            'label' => esc_html__('Product Brand - Nasa (Use slug of Brand)', 'nasa-core')
        );
        ...
        if (defined('PWB_PLUGIN_NAME')) {
            $this->settings['pwb_brand'] = array(
                ...
                'std' => '',
                'label' => esc_html__('Product PWB Brand - (Use slug of Brand)', 'nasa-core')
            );
        }
