...
class Nasa_Countdown_WGSC extends Nasa_Elementor_Widget {
    ...
    function __construct() {
        ...
        $this->widget_description = esc_html__('Display Countdown Time', 'nasa-core');
...
class Nasa_Service_Box_WGSC extends Nasa_Elementor_Widget {
    ...
    function __construct() {
        ...
        $this->widget_description = esc_html__('Display Service Box', 'nasa-core');
...
class Nasa_Icon_Box_WGSC extends Nasa_Elementor_Widget {
    ...
    function __construct() {
        ...
        $this->widget_description = esc_html__('Display Icon Box', 'nasa-core');
        $this->widget_id = 'nasa_icon_box';
        $this->widget_name = esc_html__('Nasa Icon Box', 'nasa-core');
        $this->settings = array(
            'box_img' => array(
                'type' => 'attach_image',
                'std' => '',
                'label' => esc_html__('Box Image', 'nasa-core')
            ),
            
            'box_title' => array(
                'type' => 'text',
                'std' => '',
                'label' => esc_html__('Box Title', 'nasa-core')
            ),
            
            'box_desc' => array(
                'type' => 'text',
                'std' => '',
                'label' => esc_html__('Box Description', 'nasa-core')
            ),
            
            'box_link' => array(
                'type' => 'text',
                'std' => '',
                'label' => esc_html__('Box Link', 'nasa-core')
            ),
            ...
            'box_style' => array(
                'type' => 'select',
                'std' => 'hoz',
                'label' => esc_html__('Box Style', 'nasa-core'),
                'options' => array(
...
class Nasa_Image_WGSC extends Nasa_Elementor_Widget {
    ...
    function __construct() {
        ...
        $this->widget_description = esc_html__('Display Image', 'nasa-core');
...
class Nasa_Icons_WGSC extends Nasa_Elementor_Widget {
    ...
    function __construct() {
        ...
        $this->widget_description = esc_html__('Display Header Icons', 'nasa-core');
