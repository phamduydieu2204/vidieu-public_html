...
class Nasa_Product_Categories_WGSC extends Nasa_Elementor_Widget {
    ...
    function __construct() {
        ...
        $this->widget_description = esc_html__('Display Product Categories', 'nasa-core');
        ...
        $this->settings = array(
            ...
            'disp_type' => array(
                ...
                'options' => array(
                    ...
                    'grid-2' => esc_html__('Grid 2', 'nasa-core')
                )
            ),
            ...
            'number_vertical' => array(
                'type' => 'select',
                'std' => 4,
                'label' => esc_html__('Available Vertical', 'nasa-core'),
