...
class Nasa_Products_Masonry_WGSC extends Nasa_Elementor_Widget {
    ...
    function __construct() {
        ...
        $this->widget_description = esc_html__('Display Shortcode Nasa Products Masonry', 'nasa-core');
        ...
        $this->settings = array(
            ...
            'layout' => array(
                ...
                'options' => array(
                    '1' => esc_html__('Type 1 (Limit 18 items)', 'nasa-core'),
                    '2' => esc_html__('Type 2 (Limit 16 items)', 'nasa-core')
                )
            ),
