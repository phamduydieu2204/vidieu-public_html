...
class Nasa_Products_By_Ids_WGSC extends Nasa_Elementor_Widget {
    ...
    function __construct() {
        ...
        $this->widget_description = esc_html__('Display Products By Ids', 'nasa-core');
        ...
        $this->settings = array(
            ...
            'arrows' => array(
                'type' => 'select',
                'std' => '1',
                'label' => esc_html__('Arrows (Only use for Style is Slider.)', 'nasa-core'),
            ...
            'dots' => array(
                'type' => 'select',
                'std' => 'false',
                'label' => esc_html__('Dots (Only use for Style is Slider.)', 'nasa-core'),
            ...
            'auto_slide' => array(
                'type' => 'select',
                'std' => 'false',
                'label' => esc_html__('Slide Auto (Only use for Style is Slider.)', 'nasa-core'),
                'options' => $this->array_bool_str() 
            ),
            ...
            'auto_delay_time' => array(
                "type" => "text",
                "std" => '6',
                "label" => esc_html__("Delay Time (s) (Only use for Style is Slider.)", 'nasa-core')
            ),
