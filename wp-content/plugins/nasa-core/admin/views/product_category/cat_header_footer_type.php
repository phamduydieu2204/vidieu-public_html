...
if (is_object($term) && $term) {
    ...
    <!-- Vertical Menu Root -->
    <tr class="form-field vertical-menu-root nasa-term-root hidden-tag">
        <th scope="row" valign="top">
        ...
        <td>
            <div class="nasa_vertical-menu-root">
                <select name="<?php echo $this->_cat_header_vertical_menu_root; ?>" id="<?php echo $this->_cat_header_vertical_menu_root; ?>" class="postform">
                    ...
                    <option value="2"<?php echo $vmenu_root == '2' ? ' selected' : ''; ?>><?php echo esc_html__('No, Thank!', 'nasa-core'); ?></option>
                </select>
            </div>
            <div class="clear"></div>
        </td>
    ...
    <!-- Topbar -->
    <tr class="form-field topbar_on nasa-term-root hidden-tag">
        <th scope="row" valign="top">
        ...
        <td>
            <div class="nasa_topbar_on">
                <select name="<?php echo $this->_cat_topbar_on; ?>" id="<?php echo $this->_cat_topbar_on; ?>" class="postform">
                    ...
                    <option value="2"<?php echo $cat_topbar_on == '2' ? ' selected' : ''; ?>><?php echo esc_html__('No, Thank!', 'nasa-core'); ?></option>
                </select>
            </div>
            <div class="clear"></div>
        </td>
    ...
    <tr class="space-admin nasa-term-root hidden-tag"><td colspan="2"></td></tr>
    ...
    <tr class="form-field nasa-term-root hidden-tag">
        ...
        <td>
            ...
            echo '<option value="">' . esc_html__("Default", 'nasa-core') . '</option>';
            echo (!isset($nasa_opt['f_buildin']) || $nasa_opt['f_buildin']) ? '<option value="build-in"' . ($selected == 'build-in' ? ' selected' : '') . '>' . esc_html__('Build-in', 'nasa-core') . '</option>' : '';
    ...
    <tr class="form-field nasa-term-root-child <?php echo $this->_cat_footer_mode . ' nasa-term-' . $this->_cat_footer_mode . '-build-in'; ?> hidden-tag">
        <th scope="row" valign="top">
            <label for="<?php echo $this->_cat_footer_build_in; ?>"><?php esc_html_e('Footer Build-in', 'nasa-core'); ?></label>
        </th>
        <td>
            <?php
    ...
    <tr class="form-field nasa-term-root-child <?php echo $this->_cat_footer_mode . ' nasa-term-' . $this->_cat_footer_mode . '-build-in'; ?> hidden-tag">
        <th scope="row" valign="top">
            <label for="<?php echo $this->_cat_footer_build_in_mobile; ?>"><?php esc_html_e('Footer Build-in Mobile', 'nasa-core'); ?></label>
        </th>
        <td>
            <?php
    ...
    <!-- Vertical Menu Root -->
    <div class="form-field term-cat_header-vertical-menu-root-wrap nasa-term-root hidden-tag">
        ...
        <div class="nasa_vertical-menu-root">
            <select name="<?php echo $this->_cat_header_vertical_menu_root; ?>" id="<?php echo $this->_cat_header_vertical_menu_root; ?>" class="postform">
                ...
                <option value="2"><?php echo esc_html__('No, Thank!', 'nasa-core'); ?></option>
            </select>
        </div>
        <div class="clear"></div>
    </div>
    ...
    <!-- Topbar -->
    <div class="form-field term-topbar_on-wrap nasa-term-root hidden-tag">
        <label for="<?php echo $this->_cat_topbar_on; ?>"><?php _e('Top Bar', 'nasa-core'); ?></label>
        <div class="nasa_topbar_on">
            <select name="<?php echo $this->_cat_topbar_on; ?>" id="<?php echo $this->_cat_topbar_on; ?>" class="postform">
                <option value=""><?php echo esc_html__('Default', 'nasa-core'); ?></option>
    ...
    <!-- Header BG Color -->
    <div class="form-field term-header_bg_color-wrap nasa-term-root hidden-tag">
        <label for="<?php echo $this->_cat_header_bg_color; ?>"><?php _e('Header Background', 'nasa-core'); ?></label>
        <div class="nasa_p_color">
    ...
    <!-- Header Text Color -->
    <div class="form-field term-header_text_color-wrap nasa-term-root hidden-tag">
        <label for="<?php echo $this->_cat_header_text_color; ?>"><?php _e('Header Text', 'nasa-core'); ?></label>
        <div class="nasa_p_color">
    ...
    <!-- Header Text Color Hover -->
    <div class="form-field term-header_text_color_hv-wrap nasa-term-root hidden-tag">
        <label for="<?php echo $this->_cat_header_text_color_hv; ?>"><?php _e('Header Text Hover', 'nasa-core'); ?></label>
        <div class="nasa_p_color">
    ...
    <div class="space-admin nasa-term-root hidden-tag"></div>
    ...
    <div class="form-field nasa-term-root hidden-tag">
        ...
        echo '<p><select id="' . $this->_cat_footer_mode . '" name="' . $this->_cat_footer_mode . '">';
        echo '<option value="">' . esc_html__("Default", 'nasa-core') . '</option>';
        echo (!isset($nasa_opt['f_buildin']) || $nasa_opt['f_buildin']) ? '<option value="build-in">' . esc_html__('Build-in', 'nasa-core') . '</option>' : '';
