...
<div class="form-field nasa-term-root-child <?php echo $this->_cat_logo_flag . ' nasa-term-' . $this->_cat_logo_flag . '-on'; ?> hidden-tag">
    <label><?php _e('Logo', 'nasa-core'); ?></label>
...
<div class="form-field nasa-term-root-child <?php echo $this->_cat_logo_flag . ' nasa-term-' . $this->_cat_logo_flag . '-on'; ?> hidden-tag">
    <label><?php _e('Logo Retina', 'nasa-core'); ?></label>
...
<div class="form-field nasa-term-root-child <?php echo $this->_cat_logo_flag . ' nasa-term-' . $this->_cat_logo_flag . '-on'; ?> hidden-tag">
    <label><?php _e('Logo Sticky', 'nasa-core'); ?></label>
...
<div class="form-field nasa-term-root-child <?php echo $this->_cat_logo_flag . ' nasa-term-' . $this->_cat_logo_flag . '-on'; ?> hidden-tag">
    <label><?php _e('Logo Mobile', 'nasa-core'); ?></label>
