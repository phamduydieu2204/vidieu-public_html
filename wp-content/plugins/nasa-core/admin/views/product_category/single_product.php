...
if (is_object($term) && $term) {
    ...
    <!-- BG color layout for Modern 3 -->
    <tr class="form-field nasa-term-root-child <?php echo $this->_product_layout . ' nasa-term-' . $this->_product_layout . '-modern-2 nasa-term-' . $this->_product_layout . '-modern-3'; ?> hidden-tag">
        <th scope="row" valign="top">
...
<?php } else { ?>
    ...
    <!-- BG Layout for Modern 3 -->
    <div class="form-field nasa-term-root-child <?php echo $this->_product_layout . ' nasa-term-' . $this->_product_layout . '-modern-2 nasa-term-' . $this->_product_layout . '-modern-3'; ?> hidden-tag">
        <label for="<?php echo $this->_product_layout_bg_color; ?>"><?php _e('Background Single Product Layout', 'nasa-core'); ?></label>
        <div class="nasa_p_color">
