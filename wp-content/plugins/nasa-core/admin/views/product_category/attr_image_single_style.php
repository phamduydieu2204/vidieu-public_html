...
$display_type = array(
    ...
    "extends" => esc_html__("Extends from Attribute Image Style", 'nasa-core'),
...
if (is_object($term) && $term) {
    ...
    <tr class="form-field nasa-term-root hidden-tag">
        <th scope="row" valign="top">
            <label for="<?php echo $this->_cat_attr_color_style; ?>"><?php esc_html_e('Attribute Image Style', 'nasa-core'); ?></label>
        </th>
        <td>             
            <?php
...
<?php } else { ?>
    <div class="form-field nasa-term-root hidden-tag">
        <label for="<?php echo $this->_cat_attr_image_single_style; ?>"><?php esc_html_e('Attribute Image Style', 'nasa-core'); ?></label>
        <?php
        echo '<p><select id="' . $this->_cat_attr_image_single_style . '" name="' . $this->_cat_attr_image_single_style . '">';
        foreach ($display_type as $slug => $name) {
