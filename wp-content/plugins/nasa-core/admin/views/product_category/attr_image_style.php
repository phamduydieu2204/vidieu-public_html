...
if (is_object($term) && $term) {
    ...
    <tr class="form-field nasa-term-root hidden-tag">
        <th scope="row" valign="top">
            <label for="<?php echo $this->_cat_attr_image_style; ?>"><?php esc_html_e('Attribute Image Style', 'nasa-core'); ?></label>
        </th>
        <td>             
            <?php
            ...
            <p class="description"><?php esc_html_e('Only Apply for Loop (Grid)', 'nasa-core'); ?></p>
        </td>
    </tr>
<?php } else { ?>
