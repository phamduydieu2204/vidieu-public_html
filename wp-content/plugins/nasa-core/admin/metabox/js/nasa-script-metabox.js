jQuery(document).ready(function($){
	...
	if ($(this).is(':checked')){
		...
		// $('.nasa-breadcrumb-bg-color').fadeIn(200);
            ...
            $('.nasa-breadcrumb-align').fadeIn(200);
	} else {
            $('.nasa-breadcrumb-layout').fadeOut(200);
	    ...
	    $('.nasa-breadcrumb-align').fadeOut(200);
	}
    });
