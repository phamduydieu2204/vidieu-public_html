...
function nasa_meta_boxes(array $meta_boxes) {
    ...
    $meta_boxes['nasa_metabox_general'] = array(
        ...
        'fields' => array(
            ...
            array(
                'name' => esc_html__('Attribute Image Style', 'nasa-core'),
            ...
            array(
                'name' => esc_html__('Effect Hover Product', 'nasa-core'),
        ...
        'fields' => array(
            array(
                ...
                'options' => array(
                    ...
                    '7' => esc_html__('Header Type 7', 'nasa-core'),
            ...
            array(
                ...
                'default' => '',
                'class' => 'hidden-tag nasa-core-option-child core' . $prefix . 'custom_header core' . $prefix . 'custom_header-1 core' . $prefix . 'custom_header-2 core' . $prefix . 'custom_header-3 core' . $prefix . 'custom_header-5 core' . $prefix . 'custom_header-7'
            ),
            ...
            array(
                'name' => esc_html__('Top Bar', 'nasa-core'),
                'id' => $prefix . 'topbar_on',
                'type' => 'select',
                'options' => array(
                    '' => esc_html__('Default', 'nasa-core'),
            ...
            array(
                'name' => esc_html__('Toggle Top Bar - Initialize', 'nasa-core'),
            ...
            array(
                "name" => esc_html__("Vertical Menu Root", 'nasa-core'),
                'desc' => esc_html__('Only show root menu items - Parent - 0', 'nasa-core'),
                "id" => $prefix . "v_root",
                "default" => '0',
                "type" => "checkbox"
            ),
            ...
            array(
                'name' => esc_html__('Vertical Menu Root - Limit', 'nasa-core'),
            ...
            array(
                "name" => esc_html__("Vertical Menu Visible", 'nasa-core'),
                'desc' => esc_html__('Yes, Please!', 'nasa-core'),
    ...
    if (!isset($nasa_opt['f_buildin']) || $nasa_opt['f_buildin']) {
        $modes["build-in"] = esc_html__("Build-in", 'nasa-core');
    }
    
    $modes["builder"] = esc_html__("Builder", 'nasa-core');
