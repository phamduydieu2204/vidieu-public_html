...
function nasa_single_product_layouts() {
    $options = array(
        ...
        "new"       => esc_html__("Gallery Grid", 'nasa-core'),
        "new-2"     => esc_html__("Gallery Grid 2", 'nasa-core'),
        "full"      => esc_html__("Slider - Fullwidth", 'nasa-core'),
        "modern-1"  => esc_html__("Purchase Focus", 'nasa-core'),
        "modern-2"  => esc_html__("With Background", 'nasa-core'),
        "modern-3"  => esc_html__("With Background 2", 'nasa-core'),
    );
...
function nasa_single_product_images_layout() {
    $options = array(
        "double" => esc_html__("2 Columns", 'nasa-core'),
        "single" => esc_html__("1 Column", 'nasa-core')
    );
...
function nasa_single_product_tabs_style() {
    $options = array(
        ...
        "accordion"         => esc_html__("Accordion - Border", 'nasa-core'),
        "accordion-2"       => esc_html__("Accordion - No Border", 'nasa-core'),
        "small-accordion"   => esc_html__("Accordion in Content", 'nasa-core'),
        "scroll-down"       => esc_html__("Scroll Down", 'nasa-core'),
        "ver-1"             => esc_html__("Vertical", 'nasa-core'),
        "ver-2"             => esc_html__("Vertical Expanded", 'nasa-core'),
    );
...
function nasa_product_card_layouts() {
    $options = array(
        ...
        "modern-7"      => esc_html__("Style 9", 'nasa-core'),
    );
