            ...
            switch ($setting['type']) {
                ...
                case 'product_brands':
                    ...
                    <div class="nasa-brands-wrap nasa-root-wrap">
                        ...
                        <div class="info-selected" data-no-selected="<?php echo esc_html__('There is not Brand selected.', 'nasa-core'); ?>">
                            <?php if($term) : ?>
                                <p class="brand-name">
                                    <?php echo $term->name; ?> ( <?php echo $term->slug; ?> )
                                </p>
                ...
                case 'product_pwb_brands':
                    ...
                    <div class="nasa-pwb-brands-wrap nasa-root-wrap">
                        ...
                        <div class="info-selected" data-no-selected="<?php echo esc_html__('There is not Brand (PWB) selected.', 'nasa-core'); ?>">
                            <?php if($term) : ?>
